                ...
                <div className="row">
                    ...
                    <div className="col">
                        <div className="card-body">
                            <p className="card-text aboutText">I am an artist turned web developer. After studying graphic design in college and dabbling in many other mediums, I decided to try something new. I want to build things to help others and make them smile, and in at least that small way, help develop our society into something we can all be proud of.
